				...
				<footer className="footer" id="contact">
					...
					<div className="container footer-container">
						<div className="content">
							<p id="footer-title" className="footer-title fadeIn">Contact Us</p>
							<p className="footer-p fadeIn">info@mega-mate.com</p>
						</div>
						<div className="content">
							<a className="logo-link" href="https://www.facebook.com/megamate.sodafactory/" target="_blank">
								<p className="footer-logo fadeinLeft">Facebook</p>
							</a>
							<a className="logo-link" href="https://www.instagram.com/mega_mate/" target="_blank">
							<p className="footer-logo fadeinLeft">Instagram</p>
							</a>
							<a className="logo-link" href="https://www.sodafactory.se" target="_blank">
							<p className="footer-logo fadeinLeft">SodaFactory</p>
							</a>
						</div>
					</div>
